...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        ...
        imagem_original = pygame.image.load(
            "PLAYER.png").convert_alpha()       # NAVE DO PLAYER
...
class Enemy(pygame.sprite.Sprite):
    def __init__(self, difficulty_speed):
        ...
        if difficulty_speed == 0:
            # Velocidade facil entre 0.5 e 1.5
...
class Boss(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        imagem_original = pygame.image.load(
            "BOSS.png").convert_alpha()                # Darth Vader
    ...
    def shoot(self, all_sprites, enemy_bullets):
        if random.random() > 0.96:                                              # BOSS atira mais rápido
...
class Bacta(pygame.sprite.Sprite):                                  # Item de Vida
